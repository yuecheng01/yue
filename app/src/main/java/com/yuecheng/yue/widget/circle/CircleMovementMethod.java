...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = YUE_AppUtils.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = YUE_AppUtils.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
