 ...
 * @date 16/4/10.
 */
public class YUE_DampScrollView extends ScrollView {
    ...
    public YUE_DampScrollView(Context context) {
        super(context);
    }

    public YUE_DampScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
