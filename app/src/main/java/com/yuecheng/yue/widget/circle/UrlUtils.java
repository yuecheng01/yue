...
import com.yuecheng.yue.ui.activity.impl.YUE_WebActivity;
import com.yuecheng.yue.widget.circle.SpannableClickable;
                    ...
                    if(!TextUtils.isEmpty(url)){
                        sp.setSpan(new SpannableClickable(){
                            ...
                            public void onClick(View widget) {
                                ...
                                Context context = widget.getContext();
                                Intent intent = new Intent(context,YUE_WebActivity.class);
