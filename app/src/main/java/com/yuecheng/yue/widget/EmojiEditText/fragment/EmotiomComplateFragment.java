...
import com.yuecheng.yue.widget.EmojiEditText.EmojiIndicatorView;
import com.yuecheng.yue.widget.EmojiEditText.adapter.EmotionGridViewAdapter;
import com.yuecheng.yue.widget.EmojiEditText.adapter.EmotionPagerAdapter;
...
public class EmotiomComplateFragment extends BaseFragment {
    ...
    private GridView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int gvHeight) {
        ...
        //设置全局点击事件
//        gv.setOnItemClickListener(GlobalOnItemClickManagerUtils.getInstance().getOnItemClickListener(emotion_map_type));
        gv.setOnItemClickListener(GlobalOnItemClickManagerUtils.getInstance().getOnItemClickListener(emotion_map_type));
        return gv;
    }
