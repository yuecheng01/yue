...
public class PraiseListView extends TextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color,getResources()
                    .getColor(R.color.praise_item_default));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_color,
                    getResources().getColor(R.color.praise_item_selector_default));
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            typedArray.recycle();
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(YUE_AppUtils.getAppContext(), R.drawable.icon_praise,
