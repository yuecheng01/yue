...
public class CommentDialog extends Dialog implements
	...
	YUE_CircleAdapter.CircleItemClickListenerCallBack mCallBack;

	public CommentDialog(Context context,YUE_CircleAdapter.CircleItemClickListenerCallBack callback,
